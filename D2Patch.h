...
static const DLLPatchStrc gptTemplatePatches[] =
{
    ...
    */
    ...
    { D2DLL_D2DDRAW, { 0x85C2 + 1, -1 + 1 }, (DWORD)HD::ResizeDDrawWindow_Interception, TRUE, 0 },

    { D2DLL_D2DDRAW, { 0x85F9, -1 }, PATCH_NOPBLOCK, FALSE, 0x8600 - 0x85F9 },

    // Fix Direct3D Fullscreen
    { D2DLL_D2DIRECT3D, { 0xB9A4, -1 }, PATCH_NOPBLOCK, FALSE, /*0xB9D0*/ 0xB9DF - 0xB9A4 },
    { D2DLL_D2DIRECT3D, { 0xB9A4, -1 }, PATCH_CALL, FALSE, 0 },
    { D2DLL_D2DIRECT3D, { 0xB9A4 + 1, -1 + 1 }, (DWORD)HD::ResizeD3DWindow_Interception, TRUE, 0 },
